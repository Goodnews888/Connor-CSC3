...
class MyGUI():
        ...
        if word_entry.__len__()!=0:
            for x in self.random_letter:
                if word_entry[0].upper() == x:
                    ...
                    f = r"AS91906\vocab_game\words_alpha.txt"
    ...
    def __init__(self):
        ...
        logo=Image.open(r"AS91906\vocab_game\image\logo1.png")
        ...
        time=Image.open(r"AS91906\vocab_game\image\time.PNG")
        score=Image.open(r"AS91906\vocab_game\image\score.PNG")
        square=Image.open(r"AS91906\vocab_game\image\square.PNG")
